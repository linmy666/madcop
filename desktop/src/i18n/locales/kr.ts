...
export const kr: Record<TranslationKey, string> = {
  ...
  // ── auto-filled from en (167 missing keys — translate me ──
  ...
  'settings.activity.subtitleLoading': '로컬 MadCop Agent CLI 세션 기록을 기반으로 합니다',
  ...
  'settings.terminal.description': '플러그인, 스킬, MCP 설정을 위해 호스트 컴퓨터의 명령을 실행합니다. 데스크톱 앱에는 madcop-haha가 포함되어 있습니다. 문서의 madcop <args>를 madcop-haha <args>로 바꾸세요. 예: claude-haha plugin install ... 또는 claude-haha mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '다음만 지웁니다: madcop-agent-open-tabs, madcop-agent-session-runtime, madcop-agent-theme, madcop-agent-locale, madcop-agent.persistence.schemaVersion.',
  ...
  'settings.providers.customIntro': 'MadCop에는 MiniMax가 기본 구성되어 있습니다. 아래 버튼을 클릭하여 커스텀 모델 공급자를 관리하세요.',
    'settings.providers.customLogin.intro': 'MadCop에는 MiniMax가 기본 구성되어 있습니다. 아래 버튼을 클릭하여 커스텀 모델 공급자를 관리하세요.',
  'settings.providers.customLogin.loginButton': '커스텀 모델 추가',
  'settings.providers.customLogin.loginStarting': '여는 중…',
  'settings.providers.customLogin.logoutButton': '로그아웃',
  'settings.providers.customLogin.logoutProcessing': '처리 중…',
  'settings.providers.customLogin.loggedInPrefix': '로그인됨 (MadCop',
  'settings.providers.customLogin.subTypeUnknown': '알 수 없음',
  'settings.providers.customLogin.errorPrefix': '오류: ',
  'settings.providers.customLogin.openBrowserFailed': '브라우저를 열지 못했습니다. 승인 URL에 수동으로 접속하세요.',
  ...
  'settings.providers.settingsJsonDesc': '~/.madcop/madcop-agent/settings.json — 직접 편집할 수 있습니다. 저장 시 기록됩니다.',
  ...
  'settings.adapters.description': 'Telegram, WeChat, DingTalk, WhatsApp, Feishu를 통해 MadCop와 채팅할 수 있도록 IM 어댑터를 구성합니다. 자세한 설정은',
  ...
  'settings.mcp.targetProject.globalHint': 'User 범위는 대상 프로젝트가 필요 없습니다. 전역 MadCop 구성에 저장되며 어디서나 사용할 수 있습니다。',
  ...
  'settings.agents.description': '기본 제공, 프로젝트, 사용자 소스 전반에서 MadCop가 사용할 수 있는 에이전트를 살펴봅니다. TUI에서 /agents를 사용하면 활성 소스와 재정의를 확인할 수 있습니다.',
  ...
  'settings.skills.description': '스킬은 Claude에 전문 기능을 추가합니다. 스킬은 ~/.madcop/skills에서 관리합니다',
  ...
  'settings.skills.emptyHint': '~/.madcop/skills에 스킬을 추가하여 시작하세요',
  ...
  'settings.memory.description': 'Claude가 각 프로젝트용으로 작성하는 Markdown 메모리 파일을 확인하고 편집합니다. 이 파일들은 ~/.madcop/projects/<project>/memory/ 아래에 저장되며 CLI 런타임에 의해 로드됩니다.',
  ...
  'settings.computerUse.appsDescription': '컴퓨터 사용을 위해 앱을 사전 승인합니다. 승인된 앱은 실행 중 확인 없이 MadCop가 제어할 수 있습니다.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'madcop-agent 데이터용 폴더 선택',
  ...
  'settings.general.storageMoveHint': '디렉터리를 전환해도 기존 데이터는 마이그레이션되지 않습니다. 이전 세션을 계속 표시하려면 이전 디렉터리에서 projects, skills, plugins, madcop-agent 및 관련 폴더를 복사하세요. 포터블 번들의 경우 이 폴더를 앱 옆에 두고 함께 압축하세요.',
  ...
  'settings.general.outputStyleDescription': '새 세션 또는 다시 시작한 세션에서 MadCop가 응답하는 방식을 선택합니다.',
  ...
  'settings.general.outputStyleScopeLocalHint': '활성 프로젝트의 .madcop/settings.local.json에 저장됩니다.',
  ...
  'settings.general.notificationsTestTitle': 'MadCop Agent 알림이 사용 설정되었습니다',
  ...
  'settings.general.traceHintOn': '새 세션은 간결한 요청, 응답, 상태 이벤트를 로컬 madcop-agent traces 디렉터리에 기록합니다.',
  ...
  'settings.general.webFetchPreflightDescription': '데스크톱 세션은 타사 공급자와 제한된 네트워크에서의 잘못된 실패를 피하기 위해 기본적으로 MadCop의 도메인 사전 확인을 건너뜁니다.',
  ...
  'settings.general.webSearchDescription': '에이전트 웹 검색을 공식 MadCop, 타사 공급자, 로컬 폴백 키 중 어디에서 해결할지 선택합니다.',
  ...
  'settings.general.webSearchHint': '자동은 MadCop 모델 이름에는 네이티브 MadCop 웹 검색을 사용하고, 그다음 Tavily와 Brave 키로 폴백합니다.',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '새 세션',
  'empty.subtitle': '새 코딩 세션을 시작합니다. MadCop이 프로젝트를 구축하고 디버깅하며 설계하도록 도울 준비가 되어 있습니다.',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '편집, 디버그 또는 설명을 MadCop에 요청...',
  ...
  'computerUseApproval.hideWhileWorking': 'MadCop가 작업하는 동안 다른 {count}개의 앱이 숨겨집니다.',
  'computerUseApproval.hideWhileWorkingRestore': 'MadCop가 작업하는 동안 다른 {count}개의 앱이 숨겨졌다가 MadCop가 완료되면 복원됩니다.',
  ...
  'computerUseApproval.tryAgainHint': '다시 시도하면 MadCop에 제어가 돌아가 macOS 권한 변경이 적용된 후 request_access를 한 번 더 호출할 수 있습니다.',
