...
export const zh: Record<TranslationKey, string> = {
  ...
  'sidebar.createBlankSession': '建立空白工作階段',
  ...
  'settings.activity.subtitleLoading': '基於本機 MadCop Agent CLI 會話記錄統計',
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 madcop-haha；文件裡的 madcop <引數> 可替換成 madcop-haha <引數>，例如 claude-haha plugin install ... 或 claude-haha mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：madcop-agent-open-tabs、madcop-agent-session-runtime、madcop-agent-theme、madcop-agent-locale 和 madcop-agent.persistence.schemaVersion。',
  ...
  'settings.providers.customIntro': 'MadCop 預設配置了 MiniMax 模型。點選下方按鈕管理自訂模型服務商。',
    'settings.providers.customLogin.intro': 'MadCop 預設配置了 MiniMax 模型。點選下方按鈕管理自訂模型服務商。',
  'settings.providers.customLogin.loginButton': '添加自訂模型服務商',
  'settings.providers.customLogin.loginStarting': '正在啟動…',
  'settings.providers.customLogin.logoutButton': '登出',
  'settings.providers.customLogin.logoutProcessing': '處理中…',
  'settings.providers.customLogin.loggedInPrefix': '已登入(MadCop',
  'settings.providers.customLogin.subTypeUnknown': '未知',
  'settings.providers.customLogin.errorPrefix': '錯誤:',
  'settings.providers.customLogin.openBrowserFailed': '無法開啟瀏覽器,請手動訪問授權連結。',
  ...
  'settings.providers.activeModel': '目前模型',
  'settings.providers.activeModelDesc': '用於主對話。其他 Claude 槽位會自動同步。',
  ...
  'settings.providers.settingsJsonDesc': '~/.madcop/madcop-agent/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.adapters.description': '配置即時通訊介面卡，透過 Telegram、微信、釘釘、WhatsApp 或飛書與 MadCop Agent 對話。首次配置請參考',
  ...
  'settings.mcp.scopeDesc.user': '寫入你的全域性 MadCop 配置，對所有專案生效。',
  ...
  'settings.mcp.form.createHint': '按當前 MadCop Agent 支援的欄位新增一個自定義 MCP 服務。',
  ...
  'settings.mcp.targetProject.globalHint': '全域性使用者不需要選擇專案。它會寫入你的全域性 MadCop 配置，並對所有專案生效。',
  ...
  'settings.skills.description': '技能擴充套件 MadCop 的能力。在 ~/.madcop/skills 中管理技能。',
  ...
  'settings.skills.emptyHint': '在 ~/.madcop/skills 中新增技能即可開始',
  ...
  'settings.memory.description': '檢視和編輯 MadCop 為每個專案寫入的 Markdown 記憶檔案。這些檔案存放在 ~/.madcop/projects/<project>/memory/，會被 CLI 執行時載入。',
  ...
  'settings.plugins.emptyHint': '先在 MadCop Agent 裡安裝外掛，桌面端就可以在這裡管理。',
  ...
  'settings.computerUse.appsDescription': '預先授權 App，MadCop 將可以直接控制這些 App，無需執行時彈窗確認。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 madcop-agent 資料的資料夾',
  ...
  'settings.general.storageMoveHint': '切換目錄不會自動搬遷舊資料。如果希望舊會話繼續出現，請把原目錄下的 projects、skills、plugins、madcop-agent 等資料複製到新目錄。要做便攜包，建議把目錄放在應用旁邊並一起壓縮。',
  ...
  'settings.general.outputStyleScopeLocalHint': '已儲存到目前專案的 .madcop/settings.local.json。',
  ...
  'settings.general.notificationsTestTitle': 'MadCop Agent 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 madcop-agent traces 目錄。',
  ...
  'settings.general.webFetchPreflightDescription': '桌面端預設跳過 MadCop 的域名預檢，避免第三方服務商或受限網路下出現誤報失敗。',
  ...
  'settings.general.webSearchDescription': '配置 Agent 聯網搜尋在 MadCop 原生、第三方供應商和本地 fallback key 之間如何選擇。',
  ...
  'settings.general.webSearchHint': '自動模式會對 MadCop 模型名優先使用原生 WebSearch，失敗或非 MadCop 模型時再使用 Tavily/Brave。',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': '新建會話',
  'empty.subtitle': '開始一個新的編碼會話。MadCop 已準備好幫你構建、除錯和架構你的專案。',
  ...
  'computerUseApproval.tryAgainHint': '“稍後重試”會把控制權交還給 MadCop，讓它在 macOS 許可權生效後重新呼叫 request_access。',
