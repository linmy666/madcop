...
export const zh: Record<TranslationKey, string> = {
  ...
  'general.desc': '语言、主题、发送行为与网络偏好',
  'general.langReply': '语言与回复',
  'general.uiLanguage': '界面语言',
  'general.uiLanguageDesc': '应用 UI 显示语言',
  'general.langZh': '中文',
  'general.replyLanguage': '回复语言',
  'general.replyLanguageDesc': 'AI 回复时使用的语言',
  'general.followUser': '跟随用户',
  'general.alwaysZh': '始终中文',
  'general.alwaysEn': '始终英文',
  'general.interaction': '交互与外观',
  'general.sendKey': '发送快捷键',
  'general.sendKeyDesc': '发送消息的快捷键方式',
  'general.enterSend': 'Enter 发送 / Shift+Enter 换行',
  'general.ctrlEnterSend': 'Ctrl+Enter 发送',
  'general.theme': '主题',
  'general.themeDesc': '界面主题风格',
  'general.themeLight': '浅色',
  'general.themeDark': '深色',
  'general.themeSepia': '暖色',
  'general.uiZoom': '界面缩放',
  'general.langToggle': '语言 / Language',
  'general.langToggleDesc': '界面显示语言',
  'general.network': '网络',
  'general.webSearch': '联网搜索',
  'general.webSearchDesc': 'Agent 是否可以使用网页搜索',
  'general.timeout': '超时 (秒)',
  'general.timeoutDesc': 'AI 请求超时时间',
  'providers.refreshing': '刷新中…',
  'common.refresh': '刷新',
  'providers.probing': '探测中…',
  'providers.probeOnline': '在线探测',
  'providers.capsLoading': '加载能力信息…',
  'providers.capsEmpty': '暂无能力数据，点刷新或在线探测',
  'providers.subtitle': '管理 LLM API 提供方、模型与能力探测',
  'providers.add': '添加供应商',
  'providers.empty': '还没有配置模型供应商',
  'providers.emptyHint': '点击"添加供应商"开始配置',
  // ─── Common ──────────────────────────────────────
  'common.cancel': '取消',
  'common.save': '保存',
  'common.delete': '删除',
  ...
  'sidebar.sessionListFailed': '会话列表加载失败 — 检查后端服务是否运行，或点击重试',
  ...
  'search.global.error': '搜索失败 — 请确认后端服务已启动后重试',
  ...
  'sidebar.createBlankSession': '创建空白会话',
  ...
  'workspace.loadError': '工作区数据加载失败 — 请确认文件夹路径正确且后端服务在运行',
  ...
  'settings.activity.profileSaveFailed': '保存个人资料失败 — 请检查网络连接或后端服务后重试',
  'settings.activity.subtitleLoading': '基于本机 MadCop Agent CLI 会话记录统计',
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 madcop-haha；文档里的 madcop <参数> 可替换成 madcop-haha <参数>，例如 madcop-haha plugin install ... 或 madcop-haha mcp add ...',
  ...
  'settings.diagnostics.loadFailed': '加载诊断信息失败 — 请确认后端服务已启动',
  ...
  'settings.diagnostics.doctorSafeKeys': '只会清理：madcop-agent-open-tabs、madcop-agent-session-runtime、madcop-agent-theme、madcop-agent-locale 和 madcop-agent.persistence.schemaVersion。',
  ...
  // Settings > 官方模型登录
  'settings.providers.customIntro': '使用官方模型需要登录你的账号。点击下方按钮,浏览器会打开官方登录页面,授权后自动回到这里。',
    'settings.providers.customLogin.intro': 'MadCop 已默认配置好 MiniMax 模型。点击下方按钮管理自定义模型服务商。',
  'settings.providers.customLogin.loginButton': '添加自定义模型服务商',
  'settings.providers.customLogin.loginStarting': '正在启动…',
  'settings.providers.customLogin.logoutButton': '登出',
  'settings.providers.customLogin.logoutProcessing': '处理中…',
  'settings.providers.customLogin.loggedInPrefix': '已登录',
  'settings.providers.customLogin.subTypeUnknown': '未知',
  'settings.providers.customLogin.errorPrefix': '错误:',
  'settings.providers.customLogin.openBrowserFailed': '无法打开浏览器,请手动访问授权链接。',
  ...
  'settings.providers.activeModelDesc': '用于主对话。其他模型槽位会自动同步。',
  ...
  'settings.providers.settingsJsonDesc': '~/.madcop/madcop-agent/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.adapters.description': '配置即时通讯适配器，通过 Telegram、微信、钉钉、WhatsApp 或飞书与 MadCop Agent 对话。首次配置请参考',
  ...
  'settings.mcp.scope.madcopai': 'MadCop',
  'settings.mcp.scope.claudeai': 'Claude AI',
  'settings.general.webSearch.mode.anthropic': 'Anthropic',
  ...
  'settings.mcp.scopeDesc.user': '写入你的全局 MadCop 配置，对所有项目生效。',
  ...
  'settings.mcp.form.createHint': '按当前 MadCop Agent 支持的字段添加一个自定义 MCP 服务。',
  ...
  'settings.mcp.targetProject.globalHint': '全局用户不需要选择项目。它会写入你的全局 MadCop 配置，并对所有项目生效。',
  ...
  'settings.agents.description': '浏览 MadCop 当前可用的 Agents，包括内置、项目和用户来源。可在 TUI 中使用 /agents 查看当前生效项与覆盖关系。',
  ...
  'settings.agents.emptyHint': '在 MadCop 设置或当前项目中添加 Agent 定义后，就会显示在这里。',
  ...
  'settings.agents.modelRouting': '模型路由',
  'settings.agents.modelRoutingHint': '深度模式下可为此 Agent 单独指定模型（如规划用强模型、研究用便宜模型）',
  'settings.agents.modelPlaceholder': '模型名，例如 gpt-4o',
  'settings.agents.modelDefault': '默认: {model}',
  'settings.agents.saveRouting': '保存路由',
  'settings.agents.saving': '保存中…',
  'settings.agents.saved': '已保存',
  'settings.agents.copyPrompt': '复制提示词',
  ...
  'settings.skills.distill': '从对话蒸馏技能',
  'settings.skills.distillHint': '把一次「教我 / 怎么做」的问答落成 SKILL.md，之后相似问题可自动引用。',
  'settings.skills.distillNeedBoth': '请填写问题与回答',
  'settings.skills.distillSuccess': '已蒸馏技能：{name}',
  'settings.skills.distillFailed': '蒸馏失败',
  'settings.skills.distillTopic': '主题（可选）',
  'settings.skills.distillTopicPh': '例如：部署 FastAPI',
  'settings.skills.distillQuery': '用户问题',
  'settings.skills.distillQueryPh': '教我如何…',
  'settings.skills.distillAnswer': '助手回答',
  'settings.skills.distillAnswerPh': '粘贴一段可复用的完整回答…',
  'settings.skills.distillSubmit': '蒸馏为技能',
  ...
  'settings.skills.emptyHint': '在 ~/.madcop/skills/ 中添加技能即可开始',
  ...
  'settings.memory.description': '查看和编辑 MadCop 为每个项目写入的 Markdown 记忆文件。这些文件存放在 ~/.madcop/projects/<project>/memory/，会被 CLI 运行时加载。',
  ...
  'settings.plugins.emptyHint': '先在 MadCop Agent 里安装插件，桌面端就可以在这里管理。',
  ...
  'settings.computerUse.appsDescription': '预先授权 App，MadCop 将可以直接控制这些 App，无需运行时弹窗确认。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 madcop-agent 数据的文件夹',
  ...
  'settings.general.storageMoveHint': '切换目录不会自动搬迁旧数据。如果希望旧会话继续出现，请把原目录下的 projects、skills、plugins、madcop-agent 等数据复制到新目录。要做便携包，建议把目录放在应用旁边并一起压缩。',
  ...
  'settings.general.responseLangDescription': '指定 MadCop 始终以某种语言回复。',
  'settings.general.responseLangDefault': '默认（英语）',
  'settings.general.outputStyleTitle': '输出风格',
  'settings.general.outputStyleDescription': '选择 MadCop 在新会话或重启后的会话中如何表达。',
  ...
  'settings.general.outputStyleScopeLocalHint': '已保存到当前项目的 .madcop/settings.local.json。',
  ...
  'settings.general.notificationsTestTitle': 'MadCop Agent 通知已启用',
  ...
  'settings.general.traceHintOn': '新会话会把精简请求、响应、状态事件写入本机 madcop-agent traces 目录。',
  ...
  'settings.general.webFetchPreflightDescription': '桌面端默认跳过 MadCop 的域名预检，避免第三方服务商或受限网络下出现误报失败。',
  ...
  'settings.general.webSearchDescription': '配置 Agent 联网搜索在 MadCop 原生、第三方供应商和本地 fallback key 之间如何选择。',
  ...
  'settings.general.webSearchHint': '自动模式会对 MadCop 模型名优先使用原生 WebSearch，失败或非 MadCop 模型时再使用 Tavily/Brave。',
  ...
  'chat.pendingMessageGuide': '待发送',
  'chat.pendingMessageGuideNow': '立即发送',
  ...
  // ─── Permission Dialog ──────────────────────────────────────
  'permission.allowEditFile': '允许 MadCop {toolName} {fileName}？',
  'permission.allowEditFileGeneric': '允许 MadCop {toolName}此文件？',
  'permission.allowBash': '允许 MadCop 执行此命令？',
  'permission.allowTool': '允许 MadCop 使用 {toolName}？',
  ...
  'computerUseApproval.hideWhileWorking': 'MadCop 工作时会隐藏另外 {count} 个应用。',
  'computerUseApproval.hideWhileWorkingRestore': 'MadCop 工作时会隐藏另外 {count} 个应用，结束后会自动恢复。',
  ...
  'computerUseApproval.tryAgainHint': '“稍后重试”会把控制权交还给 MadCop，让它在 macOS 权限生效后重新调用 request_access。',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'MadCop 需要你的输入',
  ...
  'permMode.enableBypassBody': 'MadCop 将拥有<strong>不受限制的</strong>权限来执行 Shell 命令和修改以下目录中的文件:',
  ...
  // ---- composer + selectors ----
  'settings.modelPicker.label': '选择模型',
  'intensity.极速.label': '极速',
  'intensity.极速.hint': '直出答案，最快响应',
  'intensity.快速.label': '快速',
  'intensity.快速.hint': '少量思考，低延迟',
  'intensity.标准.label': '标准',
  'intensity.标准.hint': '日常工作档',
  'intensity.深入.label': '深入',
  'intensity.深入.hint': '复杂问题，多步推理',
  'intensity.深度.label': '深度',
  'intensity.深度.hint': '长链路推理，充分验证',
  'intensity.极致.label': '极致',
  'intensity.极致.hint': '全力推理，不计耗时',
  'agentMode.chat.label': '对话',
  'agentMode.chat.shortLabel': '对话',
  'agentMode.chat.desc': '智能问答，自动判断是否需要搜索/工具',
  'agentMode.task.label': '任务',
  'agentMode.task.shortLabel': '任务',
  'agentMode.create.label': '创作',
  'agentMode.create.shortLabel': '创作',
  'chat.queueNext': 'Queue next — 本轮跑完后跑这条',
  'agentMode.task.desc': '实验性：MEA循环(Manager→Executor→Auditor)，适合长程任务',
  'agentMode.create.desc': '联网检索 → 抓取 → 大纲 → 带引用正文',
  // ---- last i18n cleanups ----
  'agentMode.aria': '模式',
  'intensity.title': '思考深度',
  ...
  // ── 补齐：t() 已引用但此前缺失的 key（夜间扫描 2026-09-07）──
  'chat.emptyNoMessages': '还没有消息',
  'chat.emptyStartConversation': '在下方输入内容，开始对话',
  'chat.searchFiles': '搜索文件…',
  'chat.thoughtProcess': '思考过程',
  'chat.turnDiff': '本回合修改',
  'chat.turnDiffEmpty': '本回合没有文件落地',
  'common.fork': '从当前位置分叉',
  'common.unknownError': '未知错误',
  'openWith.externalEditor': '用编辑器打开',
  'settings.mcp.importEmpty': '请粘贴 MCP JSON 配置',
  'settings.mcp.importFailed': '导入失败',
  'settings.mcp.importJsonPh': '{\n  "mcpServers": {\n    "filesystem": {\n      "command": "npx",\n      "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"]\n    }\n  }\n}',
  'settings.mcp.importSubmit': '导入',
  'settings.mcp.importSuccess': '已导入 {count} 个服务',
