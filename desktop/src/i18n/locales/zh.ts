...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 madcop-haha；文档里的 madcop <参数> 可替换成 madcop-haha <参数>，例如 claude-haha plugin install ... 或 claude-haha mcp add ...',
  ...
  'settings.providers.customIntro': '使用官方 Claude 模型需要登录你的 Claude.ai 账号。点击下方按钮,浏览器会打开 Claude 官方登录页面,授权后自动回到这里。',
  ...
  'settings.providers.customLogin.loggedInPrefix': '已登录(Claude',
