...
export const zh: Record<TranslationKey, string> = {
  ...
  'intensity.实习生.label': '实习生',
  'intensity.实习生.hint': '快问快答，不折腾',
  'intensity.助理.label': '助理',
  'intensity.助理.hint': '简单任务，够用就好',
  'intensity.工程师.label': '工程师',
  'intensity.工程师.hint': '常规开发主力档',
  'intensity.资深.label': '资深',
  'intensity.资深.hint': '复杂问题，深思考',
  'intensity.专家.label': '专家',
  'intensity.专家.hint': '全力推理，攻坚模式',
  'intensity.传奇.label': '传奇',
  'intensity.传奇.hint': '榨干每一滴算力',
