export const en = {
  ...
  'general.desc': 'Language, theme, send behavior & network',
  'general.langReply': 'Language & reply',
  'general.uiLanguage': 'Interface language',
  'general.uiLanguageDesc': 'Language used across the app UI',
  'general.langZh': '中文',
  'general.replyLanguage': 'Reply language',
  'general.replyLanguageDesc': 'Language the AI replies in',
  'general.followUser': 'Follow user',
  'general.alwaysZh': 'Always Chinese',
  'general.alwaysEn': 'Always English',
  'general.interaction': 'Interaction & appearance',
  'general.sendKey': 'Send shortcut',
  'general.sendKeyDesc': 'How messages are sent',
  'general.enterSend': 'Enter to send / Shift+Enter for newline',
  'general.ctrlEnterSend': 'Ctrl+Enter to send',
  'general.theme': 'Theme',
  'general.themeDesc': 'Interface color scheme',
  'general.themeLight': 'Light',
  'general.themeDark': 'Dark',
  'general.themeSepia': 'Sepia',
  'general.uiZoom': 'Interface zoom',
  'general.langToggle': 'Language',
  'general.langToggleDesc': 'Display language — switches the whole UI',
  'general.network': 'Network',
  'general.webSearch': 'Web search',
  'general.webSearchDesc': 'Allow the agent to search the web',
  'general.timeout': 'Timeout (s)',
  'general.timeoutDesc': 'AI request timeout',
  'providers.refreshing': 'Refreshing…',
  'common.refresh': 'Refresh',
  'providers.probing': 'Probing…',
  'providers.probeOnline': 'Probe online',
  'providers.capsLoading': 'Loading capabilities…',
  'providers.capsEmpty': 'No capability data — refresh or probe online',
  'providers.subtitle': 'Manage LLM API providers, models and capability probes',
  'providers.add': 'Add provider',
  'providers.empty': 'No model providers configured yet',
  'providers.emptyHint': 'Click "Add provider" to get started',
  // ─── Common ──────────────────────────────────────
  ...
  'settings.nav.metaHarness': 'Task harness',
  ...
  'sidebar.organizeBy': 'Organize by',
  ...
  'sidebar.createBlankSession': 'Create blank session',
  ...
  'settings.activity.defaultHandle': 'github.com/linmy666/madcop',
  ...
  'settings.activity.subtitleLoading': 'Based on local MadCop Agent CLI session transcripts',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: madcop-agent-open-tabs, madcop-agent-session-runtime, madcop-agent-theme, madcop-agent-locale, and madcop-agent.persistence.schemaVersion.',
  ...
  // Settings > Official Model Login
  'settings.providers.customIntro': 'Using official MadCop models requires signing in to your MadCop.ai account. Click the button below to open the official MadCop login page in your browser; you\'ll be returned here after authorizing.',
    'settings.providers.customLogin.intro': 'MadCop comes with MiniMax pre-configured. Click the button below to manage custom model providers.',
  'settings.providers.customLogin.loginButton': 'Add Custom Provider',
  'settings.providers.customLogin.loginStarting': 'Opening…',
  'settings.providers.customLogin.logoutButton': 'Sign out',
  'settings.providers.customLogin.logoutProcessing': 'Processing…',
  'settings.providers.customLogin.loggedInPrefix': 'Signed in (MadCop',
  'settings.providers.customLogin.subTypeUnknown': 'Unknown',
  'settings.providers.customLogin.errorPrefix': 'Error: ',
  'settings.providers.customLogin.openBrowserFailed': 'Failed to open browser; please visit the authorization URL manually.',
  ...
  'settings.providers.activeModelDesc': 'Used for the main chat. Other MadCop slots are auto-synced.',
  ...
  'settings.providers.settingsJsonDesc': '~/.madcop/madcop-agent/settings.json — edit directly, will be written on save.',
  ...
  'settings.adapters.description': 'Configure IM adapters to chat with MadCop Agent via Telegram, WeChat, DingTalk, WhatsApp, or Feishu. For setup details, see',
  ...
  'settings.mcp.description': 'Connect external tools and data sources for MadCop Agent. Local, project, and user scopes follow the same behavior as the CLI.',
  ...
  'settings.mcp.scope.madcopai': 'MadcopAI',
  'settings.general.webSearch.mode.madcop': 'Madcop',
  ...
  'settings.mcp.scope.claudeai': 'MadCop.ai',
  ...
  'settings.mcp.form.createHint': 'Set up a custom MCP server with the fields supported by MadCop Agent today.',
  ...
  'settings.mcp.targetProject.globalHint': 'User scope does not need a target project. It is stored in your global MadCop config and is available everywhere.',
  ...
  'settings.agents.description': 'Browse agents available to MadCop across built-in, project, and user sources. Use /agents in TUI to inspect active sources and overrides.',
  ...
  'settings.agents.emptyHint': 'Add agent definitions in your MadCop settings or project to see them here.',
  ...
  'settings.agents.modelRouting': 'Model routing',
  'settings.agents.modelRoutingHint': 'In deep mode, route this agent to a dedicated model (e.g. planner → strong, researcher → cheap).',
  'settings.agents.modelPlaceholder': 'Model id, e.g. gpt-4o',
  'settings.agents.modelDefault': 'Default: {model}',
  'settings.agents.saveRouting': 'Save route',
  ...
  'settings.skills.distillTopic': 'Topic (optional)',
  'settings.skills.distillTopicPh': 'e.g. Deploy FastAPI',
  'settings.skills.distillQuery': 'User question',
  'settings.skills.distillQueryPh': 'Teach me how to…',
  'settings.skills.distillAnswer': 'Assistant answer',
  'settings.skills.distillAnswerPh': 'Paste a reusable complete answer…',
  'settings.skills.distillSubmit': 'Distill into skill',
  ...
  'settings.skills.emptyHint': 'Add skills to ~/.madcop/skills to get started',
  ...
  'settings.memory.description': 'Inspect and edit the Markdown memory files MadCop writes for each project. These files are stored under ~/.madcop/projects/<project>/memory/ and are loaded by the CLI runtime.',
  ...
  'settings.plugins.emptyHint': 'Install plugins from MadCop Agent to manage them here.',
  ...
  'settings.computerUse.description': 'Allow MadCop to take screenshots, click, type, and control your computer. Requires Python 3. On macOS, accessibility permissions are also needed.',
  ...
  'settings.computerUse.appsDescription': 'Pre-authorize apps for Computer Use. Authorized apps can be controlled by MadCop without runtime prompts.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for madcop-agent data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, madcop-agent, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.responseLangDescription': 'Instruct MadCop to always respond in a specific language.',
  'settings.general.responseLangDefault': 'Default (English)',
  'settings.general.outputStyleTitle': 'Output Style',
  'settings.general.outputStyleDescription': 'Choose how MadCop communicates in new or restarted sessions.',
  ...
  'settings.general.outputStyleScopeLocalHint': 'Saved to .madcop/settings.local.json for the active project.',
  ...
  'settings.general.notificationsTestTitle': 'MadCop Agent notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local madcop-agent traces directory.',
  ...
  'settings.general.webFetchPreflightDescription': 'Desktop sessions skip MadCop\'s domain preflight by default to avoid false failures on third-party providers and restricted networks.',
  ...
  'settings.general.webSearchDescription': 'Choose how agent web search is resolved across official MadCop, third-party providers, and local fallback keys.',
  ...
  'settings.general.webSearch.mode.anthropic': 'MadCop',
  ...
  'settings.general.webSearchHint': 'Auto uses native MadCop web search for MadCop model names, then falls back to Tavily and Brave keys.',
  ...
  'empty.subtitle': 'Start a fresh coding session. MadCop is ready to help you build, debug, and architect your project.',
  ...
  // ─── Permission Dialog ──────────────────────────────────────
  'permission.allowEditFile': 'Allow MadCop to {toolName} {fileName}?',
  'permission.allowEditFileGeneric': 'Allow MadCop to {toolName} this file?',
  'permission.allowBash': 'Allow MadCop to run this command?',
  'permission.allowTool': 'Allow MadCop to use {toolName}?',
  ...
  'permission.planPreviewTitle': "MadCop's plan",
  ...
  'permission.planFeedbackPlaceholder': 'Tell MadCop what to change',
  ...
  'computerUseApproval.reason': 'Why MadCop is asking',
  ...
  'computerUseApproval.hideWhileWorking': '{count} other apps will be hidden while MadCop works.',
  'computerUseApproval.hideWhileWorkingRestore': '{count} other apps will be hidden while MadCop works, then restored when MadCop is done.',
  ...
  'computerUseApproval.tryAgainHint': 'Try again returns control to MadCop so it can call request_access once more after macOS permission changes take effect.',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'MadCop needs your input',
  ...
  'permMode.autoAcceptDesc': 'MadCop writes to disk without asking',
  ...
  'permMode.enableBypassBody': 'MadCop will have <strong>unrestricted</strong> access to execute shell commands and modify files within:',
  ...
  // ---- composer + selectors ----
  'settings.modelPicker.label': 'Select model',
  'intensity.实习生.label': 'Intern',
  'intensity.实习生.hint': 'Quick Q&A, no fuss',
  'intensity.助理.label': 'Assistant',
  'intensity.助理.hint': 'Simple tasks, just enough',
  'intensity.工程师.label': 'Engineer',
  'intensity.工程师.hint': 'Mainstay for routine dev work',
  'intensity.资深.label': 'Senior',
  'intensity.资深.hint': 'Tough questions, deep thinking',
  'intensity.专家.label': 'Expert',
  'intensity.专家.hint': 'Full force reasoning, breakthrough mode',
  'intensity.传奇.label': 'Legend',
  'intensity.传奇.hint': 'Squeeze every drop of compute',
  'agentMode.chat.label': 'Chat',
  'agentMode.chat.shortLabel': 'Chat',
  'agentMode.chat.desc': 'Smart Q&A, auto-routes tools when needed',
  'agentMode.task.label': 'Task',
  'agentMode.task.shortLabel': 'Task',
  'agentMode.task.desc': 'Experimental: MEA loop (Manager→Executor→Auditor) for long-running work',
  'agentMode.create.label': 'Create',
  'agentMode.create.shortLabel': 'Create',
  'agentMode.create.desc': 'Search → fetch → outline → write with citations',
  ...
  // ── Backfill: keys referenced by t() but previously missing (night scan 2026-09-07) ──
  'chat.emptyNoMessages': 'No messages yet',
  'chat.emptyStartConversation': 'Type below to start the conversation',
  'chat.searchFiles': 'Search files…',
  'chat.thoughtProcess': 'Thought process',
  'chat.turnDiff': 'Changes this turn',
  'chat.turnDiffEmpty': 'No files changed this turn',
  'common.fork': 'Fork from here',
  'common.unknownError': 'Unknown error',
  'openWith.externalEditor': 'Open in Editor',
  'settings.mcp.importEmpty': 'Paste an MCP JSON config first',
  'settings.mcp.importFailed': 'Import failed',
  'settings.mcp.importJsonPh': '{\n  "mcpServers": {\n    "filesystem": {\n      "command": "npx",\n      "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"]\n    }\n  }\n}',
  'settings.mcp.importSubmit': 'Import',
  'settings.mcp.importSuccess': 'Imported {count} services',
