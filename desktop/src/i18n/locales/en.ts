export const en = {
  ...
  'settings.providers.customIntro': 'Using official Claude models requires signing in to your Claude.ai account. Click the button below to open the official Claude login page in your browser; you\'ll be returned here after authorizing.',
  ...
  'settings.memory.description': 'Inspect and edit the Markdown memory files Claude writes for each project. These files are stored under ~/.madcop/projects/<project>/memory/ and are loaded by the CLI runtime.',
