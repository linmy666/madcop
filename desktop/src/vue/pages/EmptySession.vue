...
// Example prompt chips — builder lives in the shared composable so the
// ActiveSession empty hero shows the same workspace-aware suggestions.
const { suggestions } = useEmptySuggestions()
