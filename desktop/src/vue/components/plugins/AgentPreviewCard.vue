...
// v3.0 — AgentPreviewCard (Vue 3)
// Direct translation of AgentPreviewCard component from PluginDetail.tsx
withDefaults(
  defineProps<{
    name: string
    description: string
...
<template>
  ...
  >
    <div class="flex items-start justify-between gap-3">
      <div class="min-w-0">
        <div class="text-sm font-semibold text-[var(--color-text-primary)] break-all">{{ name }}</div>
