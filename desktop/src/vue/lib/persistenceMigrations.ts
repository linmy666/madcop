...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'madcop-agent.persistence.schemaVersion'
...
const SESSION_RUNTIME_STORAGE_KEY = 'madcop-agent-session-runtime'
const THEME_STORAGE_KEY = 'madcop-agent-theme'
const LOCALE_STORAGE_KEY = 'madcop-agent-locale'
