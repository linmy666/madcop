...
from .files import ReadFileTool, WriteFileTool, EditFileTool, WriteXlsxTool, ReadOfficeTool, WritePptxTool
...
def default_registry(
    ...
    reg.register(ReadOfficeTool(allowed_dirs=_read_dirs))  # office read/verify loop
