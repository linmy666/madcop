...
BUILTIN_AGENTS = [
    ...
    {"id": "designer", "name": "设计助手", "description": "生成 UI 原型和设计稿。集成 DesignCanvas。", "icon": "palette", "model": "sensenova-6.7-flash-lite", "status": "online", "capabilities": ["UI 设计", "原型生成", "CSS 编写"], "source": "builtin", "color": "#EC4899"},
    {"id": "researcher", "name": "研究员", "description": "联网搜索、资料整理、报告生成。", "icon": "travel_explore", "model": "sensenova-6.7-flash-lite", "status": "online", "capabilities": ["网页搜索", "信息提取", "报告生成"], "source": "builtin", "color": "#10B981"},
    {"id": "planner", "name": "规划师", "description": "将复杂任务分解为多步骤计划，协调其他 agent。", "icon": "account_tree", "model": "sensenova-6.7-flash-lite", "status": "online", "capabilities": ["任务分解", "协调", "调度"], "source": "builtin", "color": "#7C3AED"},
